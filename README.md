...
The associative memory, implemented as a associative memory (AM), is where Hebbian learning happens. Rather than Hebbian rule that AM often utilized, [Generalized Hebbian algorithm](https://en.wikipedia.org/wiki/Generalized_Hebbian_Algorithm) is used, for it is demonstrably stable. 
<img src="/img/asso.png" alt="AM" width="310"/>
